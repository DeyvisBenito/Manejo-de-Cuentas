...
namespace ManejoPresupuesto.Controllers
{
    public class CuentasController : Controller
    {
        ...
        public async Task<IActionResult> Crear()
        {
            ...
            var listaTipoCuenta =await repositorioTiposCuentas.Listar(usuarioId);
            var modelo = new CreacionCuenta();
            modelo.TiposCuentas = listaTipoCuenta.Select(x => new SelectListItem(x.Nombre, x.Id.ToString()));
